...
# S3 Client configured for Supabase Storage
...
def upload_file():
    try:
        ...
        # Upload binary stream directly to Supabase Bucket
...
if __name__ == '__main__':
    # Render will assign a port dynamically via environment variables. Default to 5000 locally.
